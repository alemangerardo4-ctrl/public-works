  ...
  const products = [
    {
      ...
      tagline: 'Precision-cut stainless steel. Built to last.',
      tags: ['Made to Order', '304 Stainless'],
      status: 'available'
    },
    {
      id: 'frame-tote',
      ...
      tagline: 'Internal frame. Recycled materials. Lifetime warranty.',
      tags: ['Launch Price', 'Sustainable'],
      status: 'available'
    },
    {
      id: 'popup-camper',
